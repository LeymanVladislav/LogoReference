        ...
        <%
            ...
            if (ExercisesList != null && !ExercisesList.isEmpty()) {
                ...
                for (JDBCDriverConnection.ExercisesType s : ExercisesList) {
                    ...
                    out.println(
                               "<tr><td>" + s.name + "</td><td>" + s.description + "</td><td>" + s.dysgraphia + " <img src=\"resources\\images\\exercises\\" + s.id + ".jpg\" class=\"w3-round-xlarge\" alt=\"Norway\" style=\"width:30%\"></td></tr> <!--ряд с ячейками тела таблицы-->\n"
